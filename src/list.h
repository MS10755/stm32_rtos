...
#define LIST_ITERATOR_NEXT(l)  ((l)->iterator = (l)->iterator ? (l)->iterator->next : NULL)
#define LIST_ITERATOR_HAS(l)  ((l)->iterator ? 1 : 0)
#define LIST_ITERATOR_HAS_NEXT(l)  ((l)->iterator->next ? 1 : 0)

#define LIST_ITERATOR_GLOBAL_BEGIN(l)  ((l)->iterator_global = (l)->head)
#define LIST_ITERATOR_GLOBAL_GET(l)  ((l)->iterator_global)
#define LIST_ITERATOR_GLOBAL_NEXT(l)  ((l)->iterator_global = (l)->iterator_global ? (l)->iterator_global->next : NULL)
#define LIST_ITERATOR_GLOBAL_HAS(l)  ((l)->iterator_global ? 1 : 0)
#define LIST_ITERATOR_GLOBAL_HAS_NEXT(l)  ((l)->iterator_global->next ? 1 : 0)
...
#define LIST_NODE_GET_VALUE(n)  ((n)->value)
#define LIST_NODE_SET_DATA(n,d)  ((n)->data = d)
#define LIST_NODE_GET_DATA(n)  ((n)->data)
#define LIST_NODE_GET_OWNER(n)  ((n)->owner)
